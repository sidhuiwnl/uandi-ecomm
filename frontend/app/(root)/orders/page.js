...
import {
    Package, Clock, Truck, CheckCircle2, ArrowRight,
    Calendar, CreditCard, Eye, ChevronDown, RefreshCw
} from "lucide-react";
                                        ...
                                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                            ...
                                            <div className="flex flex-wrap gap-4 items-center">
                                                ...
                                                <div className="text-center">
                                                    ...
                                                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${paymentStatusConfig[order.payment_status?.toLowerCase()]?.color || 'bg-gray-100 text-gray-800'}`}>
                                    ...
                                    <div className="px-6 py-4 bg-gray-50 border-b border-gray-100">
                                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                            <div className="flex items-center gap-3">
                                                <div className={`px-3 py-2 rounded-full text-sm font-semibold flex items-center gap-2 ${statusConfig[order.order_status?.toLowerCase()]?.color || 'bg-gray-100 text-gray-800'}`}>
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                >
                                                    ...
                                                    <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${expandedOrder === order.order_id ? 'rotate-180' : ''}`} />
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="mt-6 p-4 bg-white border border-gray-200 rounded-lg">
                                                        ...
                                                        <div className="space-y-2 text-sm">
                                                            <div className="flex justify-between">
                                                                ...
                                                                <span>₹{order.total_amount + (order.coupon_discount || 0) - 99 - (order.total_amount * 0.18)}</span>
                                                            </div>
                                                    ...
                                                    {order.address_line_1 && (
                                                        <div className="mt-4 p-4 bg-white border border-gray-200 rounded-lg">
                                                            ...
                                                            <p className="text-sm text-gray-600">
                                                                {order.full_name} • {order.phone_number}<br/>
